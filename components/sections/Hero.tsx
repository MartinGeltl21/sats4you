  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      <AuroraBackground className="bg-[#0a0a0a] min-h-[100svh] lg:min-h-screen text-white items-start">
        ...
        <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 pt-24 md:pt-24 lg:pt-8 pb-8 flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16">
